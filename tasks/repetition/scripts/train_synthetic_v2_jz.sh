#!/bin/bash
#SBATCH --job-name=ctm_rep_synth_v2
#SBATCH -A oyr@a100
#SBATCH -C a100
#SBATCH --nodes=1
...
# Synthetic-v2 oscillating-dots — variable active span + non-stationary
# frequency + jitter, so the task can't be solved by single-period
