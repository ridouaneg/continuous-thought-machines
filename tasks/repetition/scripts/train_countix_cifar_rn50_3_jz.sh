#!/bin/bash
#SBATCH --job-name=ctm_countix_cifar_rn50_3
#SBATCH -A kcn@h100
#SBATCH -C h100
#SBATCH --nodes=1
...
# CIFAR body kept identical, encoder upgraded to resnet50-3
# (full conv1+layer1+layer2+layer3 of ImageNet-pretrained ResNet-50).
# get_d_backbone returns 1024 channels (ctm.py:333).
...
python -m tasks.repetition.train \
    ...
    --n_test_batches 30 \
    --num_workers_train 8 \
    --log_dir logs/repetition/countix_cifar_rn50_3 \
    --device 0 \
    --use_amp \
    --seed 42
